...
import 'package:campousia/Screen/ParticularHP/PHPComponents/ParticularDetails/PHPSffold/ScaffoldItems/BodyComponents/NoticeScreen.dart';
...
class _LocationShareButtonState extends State<LocationShareButton> {
  ...
  Future <void> LocationSHareTest() async
  {
    ...
    BusTrips.busTrips[Bus.indexofbustrips].Notice=widget._noticeController.text;
    NoticeScreen.noticee = widget._noticeController.text;
